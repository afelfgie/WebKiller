...
GAME_OVER[0]="\033]31;1m----------------------------------"
GAME_OVER[1]="\033[31;1m|          \033[37;1mGAME OVER !           \033]31;1m|"
GAME_OVER[2]="\033[31;1m----------------------------------"
GAME_OVER[3]="\033[36;1m╥────────────────────────────────╥"
GAME_OVER[4]="\033]36;1m║    Press ENTER to try again    ║"
GAME_OVER[5]="\033[36;1m╨────────────────────────────────╨"
...
function game_info() {
	printf "\e[$[MH+1];You: $USER (Nejlepší výkon: $TOP_SCORE)"
	printf "\e[$[MH+1];$[MW-12]fSScore: %5d" $SCORE
}
